...
import static cd.oxy.dao.DAOUtilitaire.fermeturesSilencieuses;
import static cd.oxy.dao.DAOUtilitaire.initialisationRequetePreparee;
    ...
    public void creer( Commande commande ) throws DAOException {
        ...
        try {
            ...
            if ( valeursAutoGenerees.next() ) {
                ...
                throw new DAOException( "Échec de la création de la commande en base, aucun ID autogénéré retourné." );
            }
